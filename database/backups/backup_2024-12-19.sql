...
INSERT INTO `entire_order` VALUES (12,12,1),(13,12,4),(14,12,5),(15,13,1),(16,13,4),(17,13,5),(18,14,1),(19,14,4),(20,14,5);
...
INSERT INTO `equipment` VALUES (1,8,1,41.5,45.00,'Dostępny','pobrany plik.png',NULL),(4,13,1,147,45.00,'Dostępny','NOVA 2 XPRESS.jpg',NULL),(5,13,1,170,150.00,'Dostępny','NOVA 2 XPRESS.jpg',NULL),(6,13,1,166,150.00,'Dostępny','Rallybird Soul 102 Skis.jpg',NULL),(7,13,1,174,150.00,'Dostępny','FORZA 70D V-TI KONECT.jpg',NULL),(8,13,2,26,100.00,'Dostępny','HI-Speed Pro 110 MV GW.jpg',NULL),(9,13,2,27,100.00,'Dostępny','VIZION 4B ELITE 90 GW.jpg',NULL),(10,13,3,110,75.00,'Dostępny','Hero SL.jpg',NULL);
...
CREATE TABLE `rent` (
  ...
  `R_is_completed` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`R_id`),
...
INSERT INTO `rent` VALUES (12,2,'2024-12-19','2024-12-19',240.00,1),(13,2,'2024-12-19','2024-12-19',240.00,1),(14,2,'2024-12-19','2024-12-19',240.00,1);
...
INSERT INTO `rent_price` VALUES (1,150.00,1),(2,100.00,2),(3,75.00,3),(4,30.00,4),(5,30.00,5),(6,150.00,6),(7,100.00,7);
...
INSERT INTO `service_price` VALUES (1,'Serwis nart - ostrzenie krawędzi',100.00),(2,'Serwis nart - smarowanie',50.00),(3,'Naprawa wiązań narciarskich',250.00),(4,'Serwis snowboardu - ostrzenie',100.00),(5,'Serwis snowboardu - smarowanie',70.00),(6,'Wymiana wiązań snowboardowych',80.00);
...
-- Dump completed on 2024-12-19  4:13:43
